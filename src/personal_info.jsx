    ...
    return (
        <>
            ...
            <div className="personal_element">
                ...
                <InputBoxV2 data_req={data_req} data={data_inp4} class_change1={"grider"} class_change2={"grider_inner"}></InputBoxV2>
                <RadioV2 data_req={data_req} data={data_opt} class_change1={"grider"} class_change2={"grider_inner"}></RadioV2>
                <InputBoxV2 data_req={data_req} data={data_inp5} class_change1={"grider"} class_change2={"grider_inner"}></InputBoxV2>
                <InputBoxV2 data_req={data_req} data={data_inp6} class_change1={"grider"} class_change2={"grider_inner"} typeErr={typeErr} limit={10}></InputBoxV2>
                <InputBoxV2 data_req={data_req} data={data_inp7} class_change1={"grider"} class_change2={"grider_inner_spec"}></InputBoxV2>
