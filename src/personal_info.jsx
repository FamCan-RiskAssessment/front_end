...
function PersonalInfo({data_req , data_inp1 , data_inp2 , data_inp3 , data_inp4 , data_inp5 , data_inp6 , data_inp7 , data_opt , data_check  }){
    return(
        <>
            ...
            <div className="personal_element">
                ...
                <InputBox data_req={data_req} data={data_inp2} class_change1={"grider"} class_change2={"grider_inner"}></InputBox>
                <InputBox data_req={data_req} data={data_inp3} class_change1={"grider"} class_change2={"grider_inner"}></InputBox>
                ...
                <InputBox data_req={data_req} data={data_inp6} class_change1={"grider"} class_change2={"grider_inner"}></InputBox>       
